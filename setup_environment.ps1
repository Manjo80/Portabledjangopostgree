...
<#
.SYNOPSIS
    Portable Django Tester - Umgebungs-Setup

.DESCRIPTION
    Laedt eingebettetes Python und portables PostgreSQL herunter und
    richtet die Laufzeitumgebung fuer den Portable Django Tester ein.

    Nach diesem Skript:
      python\   <- Python 3.12 (eingebettet, kein System-Python noetig)
      postgres\ <- PostgreSQL 16 (portabel, keine Installation noetig)

    Danach: PortableDjangoTester.exe starten (oder: python main.py)
...
Write-Host ""
Write-Host "  Portable Django Tester - Umgebungs-Setup" -ForegroundColor Cyan
Write-Host "  Python $PythonVersion + PostgreSQL $PgVersion" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  1. PortableDjangoTester.exe starten  (nach build_exe.bat)" -ForegroundColor White
Write-Host "     ODER: python main.py" -ForegroundColor White
Write-Host "  2. App hinzufuegen und starten" -ForegroundColor White
Write-Host "  ============================================================" -ForegroundColor Green
Write-Host ""
